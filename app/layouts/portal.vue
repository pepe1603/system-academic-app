        ...
        <div class="relative bg-background rounded-2xl shadow-2xl max-w-3xl w-full max-h-[85vh] overflow-hidden">
          ...
          <div class="p-6 md:p-8">
            ...
            <div v-if="selectedAd.linkUrl" class="flex gap-3">
              <a :href="selectedAd.linkUrl" :target="getLinkTarget(selectedAd.linkUrl)" :rel="getLinkRel(selectedAd.linkUrl)" class="inline-flex items-center justify-center px-6 py-3 text-base font-medium rounded-lg bg-primary text-primary-foreground hover:bg-primary/90">
